...
function App() {
  ...
  <BrowserRouter>
    <Routes >
      ...
      <Route path="/challenges" element={data? <Challenges state={state} setState={setState} user={data} flag={flag} setUser={setUser}/> : <Home setUser={setUser}/>} />
      ...
      <Route path="/LevelUp" element={<LevelUp user={data} />} />
    </Routes>
  </BrowserRouter>
  )
}
