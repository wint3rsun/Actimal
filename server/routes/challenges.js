...
module.exports = (db) => {
  ...
  router.get('/', (req, res) => {
    const command = "SELECT id, to_char(start_date, 'DD-MM-YYYY') AS start_date, to_char(end_date, 'DD-MM-YYYY') AS end_date, progress, quest_id FROM game_challenges ORDER BY start_date";
